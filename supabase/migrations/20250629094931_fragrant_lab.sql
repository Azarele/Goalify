/*
  # Enhanced Goals Database Integration

  1. Updates
    - Ensure goals table properly references users
    - Add proper indexes for performance
    - Update RLS policies for security
    - Add functions for goal statistics

  2. Functions
    - Function to get user goal statistics
    - Function to update goal completion with XP calculation
    - Function to get goals by user with proper filtering

  3. Security
    - Ensure all goal operations are tied to authenticated users
    - Proper RLS policies for goal access
*/
...
-- Update goals table to allow session_id to be nullable
ALTER TABLE goals ALTER COLUMN session_id DROP NOT NULL;
