/*
  # Enhanced Goals and Statistics System
  ...
  1. Database Functions
    ...
    - get_global_leaderboard: Real leaderboard data
    - get_user_rank: User ranking across different metrics

  2. Improvements
    - Make session_id nullable for goals
