/*
  ...
  2. Database Functions
    - get_user_goal_stats: Comprehensive goal statistics for users
    - complete_goal_with_xp: Complete goals with XP calculation and profile updates
    - get_user_goals: Retrieve user goals with filtering options
    - create_user_goal: Create new goals with validation

  3. Views
    - user_goal_summary: Easy access to user goal statistics for leaderboards
