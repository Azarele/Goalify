/*
  # Fix Goals Table Structure and Functions

  1. Table Updates
    - Make session_id nullable in goals table
    - Add performance indexes for goal queries
    - Ensure proper foreign key constraints

  2. Functions
    - Drop and recreate complete_goal_with_xp function with correct return type
    - Add get_user_goal_stats function for comprehensive statistics
    - Add get_user_goals function for filtered goal retrieval
    - Add create_user_goal function for goal creation

  3. Security
    - Update RLS policies for proper access control
    - Create user_goal_summary view for leaderboard functionality

  4. Performance
    - Add indexes for common query patterns
    - Optimize function performance with proper indexing
*/
